                                ...
                                <Form>
                                    ...
                                    <FormGroup>
                                        <Col sm="12" md={{ size: 12 }}>
                                            <Field name="name" placeholder="Full Name" type="text" className={'form-control-transparent' + (errors.name && touched.name ? ' is-invalid' : '')} />
                                            <ErrorMessage name="name" component="div" className="invalid-feedback" />
                                        </Col>
                                    </FormGroup>
                                    <FormGroup>
                                        <Col sm="12" md={{ size: 12 }}>
                                            <Field name="email" placeholder="Email Address" type="text" className={'form-control-transparent' + (errors.email && touched.email ? ' is-invalid' : '')} />
